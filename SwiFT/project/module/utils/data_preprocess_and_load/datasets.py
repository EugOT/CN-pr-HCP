...
class S1200(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.contrastive:
            ...
            y = torch.nn.functional.pad(y, (9, 9, 0, 0, 6, 6), value=background_value) # adjust this padding level according to your data
            ...
            rand_y = torch.nn.functional.pad(rand_y, (9, 9, 0, 0, 6, 6), value=background_value) # adjust this padding level according to your data
